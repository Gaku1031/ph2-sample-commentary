...
if (!isset($_SESSION['id'])) {
  ...
  // $_REQUESTは$_POSTや$_GETなどをまとめたものなので、厳密に記述するならurlのid=の値を取ってくるので$_GETの方がいい？？
        ...
        <form action="../../services/update_question.php" class="question-form" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-4">
            ...
            <?php foreach($choices as $key => $choice) { ?>
              <!-- サンプルコードのミス（valueのところが""で囲まれていなかったので囲まないと正しい値が出力されない -->
          ...
          <div class="mb-4">
            ...
            <!-- 3つのラジオボタンのうち正解の選択肢(valid=1)のもののみchecked属性がついている -->
            <!-- question_idとurlから取得したidが一致するchoices3つを取得してきて、それぞれ[0]=>選択肢1みたいになるようにforeachで分解 -->
            <?php foreach($choices as $key => $choice) { ?>
